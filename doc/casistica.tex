...
Non esiste un \emph{gold standard} per la diagnosi di deficit nella produzione di GH\cite{gh2003update}. La sua secrezione, infatti, è un \emph{continuum} tra normalità e deficit grave. Tuttavia non ci sono dubbi che alcuni bambini affetti da produzione deficitaria di ormone della crescita raggiungono concentrazioni di GH sotto stimolo oltre i cut-off arbitrari.

Generalmente, livelli di GH superiore a 10 ng/ml dopo un test di stimolo sono 
sufficienti per escludere un deficit di GH.

In tutti i bambini la produzione di ormone della crescita è stata valutata mediante test
provocativi, basati sull'assenza di risposta ad almeno due diversi tipi di stimolazione.
