...
\subsection*{Paziente 22}% Es. An.

I genitori del paziente erano entrambi molto bassi. Inoltre la madre aveva un lieve deficit mentale, mentre il padre presentava ipertelorismo. Il bambino aveva il torace carenato, ma non era disarmonico. Cresceva molto lentamente, presentava una statura alquanto al di sotto della norma e livelli di somatomedine bassi,ma normoresponsivi al test di generazione. Pertanto il paziente ha beneficiato della terapia rGH, come previsto dalla nota 39 in vigore all'epoca.   
...
\subsection*{Paziente 23}% Di. Al.

Il paziente aveva familiarità per bassa statura. Cresceva lentamente ed aveva una statura inferiore al terzo centile. I suoi livelli di somatomedine erano inferiori alla norma, ma normoresponsivi al test di generazione. Di conseguenza il paziente ha intrapreso la terapia con rGH. Ad essa successivamente è stata associata la terapia antipuberale quando il paziente aveva circa 12,5 anni, perchè presentava una statura di 136 cm e la pubertà già iniziata progrediva rapidamente. La terapia frenante è stata portata avanti per un anno.
...
\subsection*{Paziente 24}% Za. Ma.

La madre del paziente ha riferito minacce d'aborto; l'aumento ponderale durante la gravidanza è stato modesto. Il bambino ha presentato intolleranza alle proteine del latte vaccino. Inoltre è andato incontro a tonsilliti recidivanti. Nel primo anno di vita ha affrontato tre crisi asmatiche, in occasione delle quali ha assunto cortisonici. Presentava bassi livelli di somatomedine normoresponsivi al test di generazione, pertanto ha eseguito la terapia come previsto dalla nota 39 allora in vigore.
