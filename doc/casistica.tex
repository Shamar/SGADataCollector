...
In tutti i bambini la produzione di ormone della crescita è stata valutata mediante test provocativi, che comprendono:


\subsubsection*{test con arginina}
...
\subsubsection*{test con glucagone}
...
\subsubsection*{test con clonidina}
