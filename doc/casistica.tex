...
La statura raggiunta è da ritenersi definitiva quando la velocità di crescita è inferiore ai 2 cm/anno o l'età ossea del paziente è di almeno 15 anni nella femmina, 16 nel maschio.
...
In otto di questi sono stati riscontrati insufficienti livelli di GH in risposta a due test provocativi classici (primo test con arginina, secondo test con clonidina/ glucagone). I valori medi di GH erano compresi fra 5 e 10 \unit{\micro g}/l, trattandosi quindi di una lieve compromissione della produzione ormonale (il valore normale è superiore a 10\unit{\micro g}/l). Un solo paziente tra questi otto presentava deficit severo (entrambe le risposte erano inferiori a 5 \unit{\micro g}/l) ed alla RMN l'ipofisi è risultata ipoplasica. A fine crescita la rivalutazione della funzione ipofisaria con test provocativo massimale (arginina + GHRH) non ha confermato il deficit ormonale.
