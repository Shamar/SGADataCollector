...
Le medie relative alla pubertà sono riassunte nella tabella 4.4 a pag. 36.
...
\end{tabular}
\end{center}
\caption{Risultati della terapia con rGH ($\Delta$ SDS = guadagno staturale in SDS).}
\label{tab:Esito}
\end{table}
...
% \toprule
% \multirow{2}{*}{Modello}& \multirow{2}{*}{p} & \multicolumn{2}{c}{Intervallo di confidenza 95,0\%} \\
...
% \end{tabular} 
% \end{center}
% \caption{Coefficienti di regressione lineare multipla rispetto alla variabile dipendente definita dal guadagno in SDS.}
% \label{tab:Statistiche}
% \end{table}

La tabella 4.7 a pag. 39 riporta i coefficienti di regressione lineare multipla rispetto alla variabile dipendente definita dal guadagno in SDS.
...
\toprule
\multirow{2}{*}{Modello}	& \multirow{2}{*}{p} & \multirow{2}{*}{Coefficiente} & \multicolumn{2}{c}{Intervallo di confidenza 95,0\%} \\
\cmidrule(r){4-5}
